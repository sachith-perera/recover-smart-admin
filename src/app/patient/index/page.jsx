...
export default function Patients() {
  ...
  const handleEdit = (id) => {
    ...
    // Add your edit logic here (e.g., open edit modal or redirect)
  };
    ...
    if (result.isConfirmed) {
      try {
        ...
        if (response.ok) {
          ...
          // Here you might want to refresh the table data
          // You could pass a callback from the parent or use a state management solution
        } else {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      try {
        ...
        const response = await fetch("http://152.67.5.32/api/patients/", {
          headers: {
      ...
      <div className="row">
        <div className="col-sm-12">
          <div>
            ...
            <button style={{float:'right', marginBottom:'10px'}} className="btn btn-primary" > <i className="" ></i> Add Patient</button>
